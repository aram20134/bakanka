  ...
  return (
    <Card sx={{p:2, mt: 2, backgroundColor:'rgba(255, 255, 255, 0.7)', backdropFilter: 'saturate(200%) blur(30px)', mx: {xs: 2, lg: 3}, justifyContent:'center', alignItems:'center', display:'flex'}}>
        <Grid maxWidth={'lg'} gap={3} direction={'column'} justifyContent={'center'} alignItems={'center'} container>
          <Grid>
            <Typography textAlign={'center'} color={''} variant='h3'>Связаться с нами</Typography>
          </Grid>
          <Grid xs item container justifyContent={'center'} alignItems={'center'}>
            ...
            <Grid xs={12} md={6} p={5} item sx={{backgroundColor:'primary.main', borderBottomRightRadius:5, borderTopRightRadius:5}} gap={2} container justifyContent={'center'} alignItems={'center'}>
              <Grid gap={5} container justifyContent={'space-between'} alignItems={'flex-start'}>
                <Grid xs display={'flex'} container item direction={'column'} justifyContent={'center'} alignItems={'center'}>
